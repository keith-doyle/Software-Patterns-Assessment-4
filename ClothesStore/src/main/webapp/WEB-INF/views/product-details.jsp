...
<body>
	...
	<div class="product-box">
		<img
			...
			style="max-width: 250px; max-height: 250px; display: block; margin-bottom: 15px;">
	...
	<div class="review-form">
		...
		<form method="post"
			action="<%=request.getContextPath()%>/add-review">
			<input type="hidden" name="productId"
				value="<%=product.getProductId()%>"> <label>Rating</label>
	...
	<div class="review-box">
		...
		<p>
			<small><%=review.getCreatedAt()%></small>
		</p>
	</div>
	<%
	}
	...
	<p>
		<a href="<%=request.getContextPath()%>/products">Back to
			Products</a>
	</p>
</body>
</html>