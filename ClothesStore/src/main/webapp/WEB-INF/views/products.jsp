...
<body>
	...
	<form class="filter-form" method="get"
		...
		<label>Title:</label> <input type="text" name="title"
			value="<%=selectedTitle != null ? selectedTitle : ""%>"> <label>Category:</label>
		<select name="category">
			...
			%>
		</select> <label>Manufacturer:</label> <select name="manufacturer">
			...
			<option value="<%=manufacturer%>"
				<%=manufacturer.equals(selectedManufacturer) ? "selected" : ""%>>
				<%=manufacturer%>
			</option>
			<%
			}
	...
	<div class="product-card">
		...
		<div class="product-meta">
			Stock:
			<%=product.getStockQuantity()%></div>
		<div class="product-meta">
			Rating:
			<%=product.getAverageRating()%></div>
